...
- **Backend** — FastAPI server that validates incoming patient data, runs it through three trained models. Also maintains a live, sortable in-memory patient queue.
